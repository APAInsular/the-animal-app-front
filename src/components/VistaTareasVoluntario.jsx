    ...
    return (
        <div className="container mx-auto p-4">
            <div className="mb-8">
                ...
                <div className="task border border-gray-200 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between cursor-pointer" onClick={() => toggleSeccion('pendientes')}>
            ...
            <div className="mb-8">
                ...
                <div className="task border border-red-400 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between cursor-pointer" onClick={() => toggleSeccion('atrasadas')}>
                        <div className="flex items-center">
            ...
            <div>
                ...
                <div className="task border border-green-400 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between cursor-pointer" onClick={() => toggleSeccion('completadas')}>
                        <div className="flex items-center">
