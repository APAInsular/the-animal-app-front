			...
			<div className="flex flex-col text-gray-700 lg:flex-row lg:space-x-16 lg:space-x-reverse">
				<div className="order-1 max-w-md px-2 text-sm md:text-base lg:px-0">
					<header className="mb-6">
						<h2 className="text-4xl font-bold leading-none text-gray-600 select-none lg:text-6xl">
							404.
						</h2>
					...
					<p className="max-w-sm mb-5 leading-5 md:leading-7">
						No te preocupes, a veces incluso nosotros cometemos errores. Puedes
						encontrar muchas otras cosas en nuestra página de inicio.
					</p>
				...
				<div className="col-md-6">
					<img src="/404.png" alt="GitHub Logo" />
				</div>
			</div>
		</div>
	);
